package com.ruoyi.common.plate;
...
public class PlateLocate {
    ...
    public Vector<Mat> plateLocate(Mat src) {
        ...
        if (debug) {
        	opencv_imgcodecs.imwrite("E:/test/tmp/debug_GaussianBlur.jpg", src_blur);
        }

        // Convert it to gray 将图像进行灰度化
        cvtColor(src_blur, src_gray, CV_RGB2GRAY);
        if (debug) {
        	opencv_imgcodecs.imwrite("E:/test/tmp/debug_gray.jpg", src_gray);
        }
        ...
        if (debug) {
        	opencv_imgcodecs.imwrite("E:/test/tmp/debug_Sobel.jpg", grad);
        }
        ...
        if (debug) {
        	opencv_imgcodecs.imwrite("E:/test/tmp/debug_threshold.jpg", img_threshold);
        }
        ...
        if (debug) {
        	opencv_imgcodecs.imwrite("E:/test/tmp/debug_morphology.jpg", img_threshold);
        }
        ...
        if (debug) {
            ...
            opencv_imgcodecs.imwrite("E:/test/tmp/debug_Contours.jpg", result);
        }
        ...
        if (debug) {
        	opencv_imgcodecs.imwrite("E:/test/tmp/debug_result.jpg", result);
        }
    ...
    private Mat showResultMat(Mat src, Size rect_size, Point2f center, int index) {
        ...
        if (debug) {
        	opencv_imgcodecs.imwrite("E:/test/tmp/debug_crop_" + index + ".jpg", img_crop);
        }
        ...
        if (debug) {
        	opencv_imgcodecs.imwrite("E:/test/tmp/debug_resize_" + index + ".jpg", resultResized);
        }
