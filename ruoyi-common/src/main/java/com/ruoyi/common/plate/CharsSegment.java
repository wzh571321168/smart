...
import static com.ruoyi.common.plate.CoreFunc.getPlateType;
...
import com.ruoyi.common.smartutils.Convert;
...
public class CharsSegment {
    ...
    public int charsSegment(final Mat input, Vector<Mat> resultVec) {
        ...
        if (this.isDebug) {
        	opencv_imgcodecs.imwrite("E:/test/tmp/debug_char_threshold.jpg", img_threshold);
        }
        // 去除车牌上方的柳钉以及下方的横线等干扰
        //clearLiuDing(img_threshold);
       
        if (this.isDebug) {
            String str = "E:/test/tmp/debug_char_clearLiuDing.jpg";
        ...
        if (this.isDebug) {
            if (specIndex < sortedRect.size()) {
                ...
                String str = "E:/test/tmp/debug_specMat.jpg";
        ...
        if (this.isDebug) {
            ...
            String str = "E:/test/tmp/debug_chineseMat.jpg";
        ...
        for (int i = 0; i < newSortedRect.size(); i++) {
            ...
            if (this.isDebug) {
                String str = "E:/test/tmp/debug_char_auxRoi_" + Integer.valueOf(i).toString() + ".jpg";
